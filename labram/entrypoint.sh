...
Extract LaBraM embeddings from EDF files into Zarr stores.
...
Options:
  ...
  --backend braindecode|original   Model backend (default: braindecode)
...
Examples:
  ...
  $0 --backend original --batch-size 8 /data/input /data/output
